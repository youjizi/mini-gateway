package cn.yjz.gateway.admin.domain.manage.service;

import cn.yjz.gateway.admin.application.IConfigManageService;
...
import cn.yjz.gateway.admin.domain.manage.repository.IConfigManageRepository;
import cn.yjz.gateway.admin.infrastructure.common.Constants;
...
public class ConfigManageService implements IConfigManageService {
    ...
    @Override
    public int distributionGatewayServerNode(String groupId, String gatewayId, String systemId) {
        return configManageRepository.distributionGatewayServerNode(groupId, gatewayId, systemId);
    }
