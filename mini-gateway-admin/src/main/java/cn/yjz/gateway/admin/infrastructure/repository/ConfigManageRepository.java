...
import cn.yjz.gateway.admin.infrastructure.dao.*;
import cn.yjz.gateway.admin.infrastructure.po.*;
...
public class ConfigManageRepository implements IConfigManageRepository {
    ...
    public int distributionGatewayServerNode(String groupId, String gatewayId, String systemId) {
        return gatewayDistributionDao.inset(groupId, gatewayId, systemId);
    }
