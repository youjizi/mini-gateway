package cn.yjz.gateway.assist.config;

import cn.yjz.gateway.assist.application.GatewayApplication;
import cn.yjz.gateway.assist.domain.service.GatewayCenterService;
import cn.yjz.gateway.core.session.defaults.DefaultGatewaySessionFactory;
import cn.yjz.gateway.core.socket.GatewaySocketServer;
...
public class GatewayAutoConfig {
    ...
    @Bean
    public GatewayApplication gatewayApplication(GatewayServiceProperties properties, GatewayCenterService registerGatewayService, cn.yjz.gateway.core.session.Configuration configuration, Channel gatewaySocketServerChannel) {
     ...
     */
    @Bean
    public cn.yjz.gateway.core.session.Configuration gatewayCoreConfiguration(GatewayServiceProperties properties) {
        cn.yjz.gateway.core.session.Configuration configuration = new cn.yjz.gateway.core.session.Configuration();
    ...
    public Channel initGateway(cn.yjz.gateway.core.session.Configuration configuration) throws ExecutionException, InterruptedException {
        // 1. 基于配置构建会话工厂
